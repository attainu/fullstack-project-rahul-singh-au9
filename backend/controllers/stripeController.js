...
const stripe = Stripe('sk_test_51IY617Duc9iW3uVxhlBaepuky1UOC8dUCj4AMwlHH2gzSRZVLaWUfUGw0b1lPftj7x7SM1IAulP1zMGsVCMoxcny00Po9iaSxN');
// // this will help us create a  log-in link with some parameters in the url
// const queryString = require("query-string");

import userModel from '../models/userModel.js'
import serviceModel from '../models/orderModel.js'
import Stripe from 'stripe'
// import stripe from Stripe('sk_test_51IY617Duc9iW3uVxhlBaepuky1UOC8dUCj4AMwlHH2gzSRZVLaWUfUGw0b1lPftj7x7SM1IAulP1zMGsVCMoxcny00Po9iaSxN')
...
export {createStripeAccount, getAccountStatus, getAccountBalance, payoutSetting, stripeSessionId, stripeSuccess};