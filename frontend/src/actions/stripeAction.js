...
export const createStripeAccount = async (token) =>
  await axios.post(
    `https://urban-services.herokuapp.com/createStripeAccount`,
    {},
    {
      headers: {
...
export const getAccountStatus = async (token) =>
  await axios.post(
    `https://urban-services.herokuapp.com/get-account-status`,
    {},
    {
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getAccountBalance = async (token) =>
  await axios.post(
    `https://urban-services.herokuapp.com/get-account-balance`,
    {},
    {
      headers: {
        Authorization: `Bearer ${token}`,
...
export const payoutSetting = async (token) =>
  await axios.post(
    `https://urban-services.herokuapp.com/payout-setting`,
    {},
    {
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getSesstionId = async (token, serviceId) =>
  await axios.post(
    `https://urban-services.herokuapp.com/stripe-session-id`,
...
export const stripeSuccessRequest = async (token, serviceId) =>
    await axios.post(
      `https://urban-services.herokuapp.com/stripe-success`,{serviceId},
      {
      headers: {
        Authorization: `Bearer ${token}`,
      },
